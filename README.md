# AA2L Tagger & Manager
一个基于 WD Tagger (后续会更新其他模型) 的本地数据集批量打标与标签管理工具，提供 Web UI，辅助处理数据集。
(其实是我自己训练时没有一个顺手的工具所以试着写一个，按照我的个人训练习惯做的，可能不是很跟手 :)
...
**Q: 以后会更新吗？**
A：工作不忙可以完善一下，加其他模型以及试试打自然语言，还有加其他我喜欢的功能
